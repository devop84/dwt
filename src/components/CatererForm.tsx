...
export function CatererForm({ caterer, destinations, onClose, onSave }: CatererFormProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      if (caterer) {
        await caterersApi.update(caterer.id, {
      ...
      setError(err.response?.data?.message || err.message || 'Failed to save caterer')
    } finally {
      setLoading(false)
    }
  }
    ...
    >
      ...
      >
        <h2 style={{
          ...
          {caterer ? 'Edit Caterer' : 'Add Caterer'}
        </h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., caterer@example.com"
                style={inputStyle}
                onFocus={(e) => {
                  e.currentTarget.style.borderColor = '#3b82f6'
                  e.currentTarget.style.boxShadow = '0 0 0 3px rgba(59, 130, 246, 0.1)'
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <textarea
              ...
              rows={4}
              placeholder="Additional information about this caterer..."
              style={{
                ...inputStyle,
                resize: 'vertical',
                fontFamily: 'inherit'
          ...
          <div style={{
            ...
            >
              {loading ? 'Saving...' : caterer ? 'Update' : 'Create'}
            </button>
          </div>
        </form>
      </div>
