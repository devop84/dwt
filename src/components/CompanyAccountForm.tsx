...
export function CompanyAccountForm({ account, onClose, onSave }: CompanyAccountFormProps) {
  ...
  const handleChange = (field: string, value: string | boolean) => {
    ...
    // Clear fields that don't apply to the new account type
    ...
    >
      ...
      >
        <h2 style={{
          ...
          {account ? 'Edit Company Account' : 'Add Company Account'}
        </h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {(formData.accountType === 'bank' || formData.accountType === 'online' || formData.accountType === 'other') && (
            <div style={{ marginBottom: '1rem' }}>
          ...
          {formData.accountType === 'cash' && (
            <div style={{
              ...
              💵 Cash account - no additional details needed
            </div>
          )}

          {formData.accountType === 'bank' && (
            <>
              {(formData.accountType === 'bank' || formData.accountType === 'other') && formData.accountType !== 'cash' && (
                <div style={{ marginBottom: '1rem' }}>
                  <label htmlFor="accountNumber" style={labelStyle}>
                    Account Number
                  </label>
          ...
          {formData.accountType === 'other' && (
            <div style={{
              ...
              ℹ️ Use this for non-standard account types (cryptocurrency, gift cards, etc.)
            </div>
          )}
